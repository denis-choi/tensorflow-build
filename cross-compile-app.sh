...
bazel build $BAZEL_FLAGS -c opt --copt="-march=armv6" --copt="-mfpu=vfp" --copt="-funsafe-math-optimizations" --copt="-ftree-vectorize" --copt="-fomit-frame-pointer" tensorflow/examples/label_image/... --cpu=armeabi --crosstool_top=//tools/arm_compiler:toolchain --verbose_failures
